    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-sm text-gray-300">
          Help us tailor recommendations by letting us know your budget and skill
          level.
        </p>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  updateForm("budgetPerMonth", e.target.value)
                }
                required
                min={0}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                updateForm("investmentSkill", e.target.value)
              }
              required
              className="w-full px-4 py-3 rounded-xl border border-[#2a3865] bg-[#0f1f3f] text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
            >
        ...
        <div className="flex justify-between mt-2">
          <button
            type="button"
            onClick={prevStep}
            className="flex-1 mr-2 py-3 rounded-xl font-semibold bg-[#2a3865] hover:bg-[#374264] transition text-white"
          >
            Back
          </button>
          <button
            type="submit"
            disabled={!isValid}
            className={`flex-1 ml-2 py-3 rounded-xl font-semibold transition-transform ${
              isValid
